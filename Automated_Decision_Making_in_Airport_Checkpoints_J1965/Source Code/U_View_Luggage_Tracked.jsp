...
<head>
<title>View_Luggage_Tracked</title>
...
<div class="main style2">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
	   <h2 class="style5">  View Luggage Tracked Details </h2>
       <table width="913" border="1" align="center"  cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="108" valign="middle" bgcolor="#00FF00" style="color: #2c83b0;"><div align="center" class="style65 style105 style27 style6"><strong>Departure Time </strong></div></td>  <td width="108" valign="middle" bgcolor="#00FF00" style="color: #2c83b0;"><div align="center" class="style65 style105 style27 style6"><strong>Departure Date </strong></div></td>
			 
			  
			  <td width="108" valign="middle" bgcolor="#00FF00" style="color: #2c83b0;"><div align="center" class="style65 style105 style27 style6"><strong>Luggage1</strong></div></td>
			   <td width="108" valign="middle" bgcolor="#00FF00" style="color: #2c83b0;"><div align="center" class="style65 style105 style27 style6"><strong>Luggage2 </strong></div></td>
			    <td width="108" valign="middle" bgcolor="#00FF00" style="color: #2c83b0;"><div align="center" class="style65 style105 style27 style6"><strong>Comments </strong></div></td>
				 <td width="108" valign="middle" bgcolor="#00FF00" style="color: #2c83b0;"><div align="center" class="style65 style105 style27 style6"><strong>Date and Time</strong></div></td>
            </tr>
            <%@ include file="connect.jsp" %>
            <%
			     String pname=(String)application.getAttribute("uname");
					  
						String s1,s2,s3,s4,s5,s6,s7,s8,s9,s10,s11;
						int i=0;
						try 
						{
						   	String query="select * from trackluggage where pname='"+pname+"'"; 
